...
<?php $id='sc015'; $nav=1; $nav_items=array('ex','reqs','res'); $category='script'; $page_name='WAI-ARIA &amp; Custom Controls'; ?>
<!DOCTYPE html>
<html xml:lang="en" lang="en"
	...
	<head>
		...
		<style type="text/css">
			div#sc015-ex01-controls { margin-left: 5em; padding: 0.2em; width: 7em; text-align: center; border: 1px solid rgb(0,0,0); background-color: rgb(243,243,243) }
			div#sc015-ex01-controls img { display: inline; }
		</style>
	</head>
	...
	<body>
		...
		<section id="sc015" class="section">
			...
			<section id="sc015-desc" class="usage">
				<p>Similar to the way that the <code><a href="../semantics/epub-type.php">epub:type</a></code>
					attribute adds semantics to elements, the WAI-ARIA <code>role</code> attribute 
					can be used to inform assistive technologies about the function a custom control 
					serves (e.g., to indicate that an image functions like a button). The 
					list of supported roles for custom controls follows:</p>
				...
				<p>Defining the type of a control using the <code>role</code> attribute is only the
					first step. The state of the control, and any properties associated with it, must also
					be maintained to ensure the reader can correctly interact with the control:</p>
				
				<ul>
					<li>States tell you something about the nature of the control: whether it is currently checked
						or not, whether it is hidden, etc. These must be maintained as the reader interacts with the
						control, otherwise they may get locked out of functionality (e.g., unable to reduce the volume, 
						unable to make important content visible, etc.).</li>
					<li>Properties are typically set once and identify meta information such as the label or
						description for a control (or element).</li>
				</ul>
				
				<p>ARIA defines the following states and properties:</p>
				
				<ul class="multicol">
					<li><a href="http://www.w3.org/TR/wai-aria/states_and_properties#aria-activedescendant">aria-activedescendant</a></li>
					<li><a href="http://www.w3.org/TR/wai-aria/states_and_properties#aria-atomic">aria-atomic</a></li>
					<li><a href="http://www.w3.org/TR/wai-aria/states_and_properties#aria-autocomplete">aria-autocomplete</a></li>
					<li><a href="http://www.w3.org/TR/wai-aria/states_and_properties#aria-busy" class="state-reference">aria-busy (state)</a></li>
					<li><a href="http://www.w3.org/TR/wai-aria/states_and_properties#aria-checked" class="state-reference">aria-checked (state)</a></li>
					...
					<li><a href="http://www.w3.org/TR/wai-aria/states_and_properties#aria-disabled" class="state-reference">aria-disabled (state)</a></li>
					<li><a href="http://www.w3.org/TR/wai-aria/states_and_properties#aria-dropeffect">aria-dropeffect</a></li>
					<li><a href="http://www.w3.org/TR/wai-aria/states_and_properties#aria-expanded" class="state-reference">aria-expanded (state)</a></li>
					<li><a href="http://www.w3.org/TR/wai-aria/states_and_properties#aria-flowto">aria-flowto</a></li>
					<li><a href="http://www.w3.org/TR/wai-aria/states_and_properties#aria-grabbed" class="state-reference">aria-grabbed (state)</a></li>
					<li><a href="http://www.w3.org/TR/wai-aria/states_and_properties#aria-haspopup">aria-haspopup</a></li>
					<li><a href="http://www.w3.org/TR/wai-aria/states_and_properties#aria-hidden" class="state-reference">aria-hidden (state)</a></li>
					<li><a href="http://www.w3.org/TR/wai-aria/states_and_properties#aria-invalid" class="state-reference">aria-invalid (state)</a></li>
					...
					<li><a href="http://www.w3.org/TR/wai-aria/states_and_properties#aria-multiselectable">aria-multiselectable</a></li>
					<li><a href="http://www.w3.org/TR/wai-aria/states_and_properties#aria-orientation">aria-orientation</a></li>
					...
					<li><a href="http://www.w3.org/TR/wai-aria/states_and_properties#aria-pressed" class="state-reference">aria-pressed (state)</a></li>
					...
					<li><a href="http://www.w3.org/TR/wai-aria/states_and_properties#aria-selected" class="state-reference">aria-selected (state)</a></li>
     ...
     alt="Start"/></code></pre>
				...
				<figure id="sc015-ex02">
					...
					<p>The following simple example shows some of the considerations that have to be paid attention to
						when creating a custom control: setting and unsetting callback functions, enabling
						and disabling the control, changing the visual appearance of the buttons. To make this
						image work with keyboards, the reader's keypresses must also be monitored and actions
						turned on and off.</p>
...
&lt;/script></code></pre>
					...
					<div id="sc015-ex01-controls">
						...
						<img src="../../graphics/stop-disabled.png"
							width="32"
							height="32"
							id="audio-stop"
							alt="Stop"
			...
			<section id="sc015-samp" class="sample">
				<h3>Samples</h3>
				<ul>
					<li><a href="http://test.cita.uiuc.edu/aria/">Illinois Center for Information Technology and Web Accessibility &#8212; ARIA Examples</a></li>
				</ul>
			</section>
			...
			<section id="sc015-reqs" class="reqs">
				...
				<ul>
					...
					<li>WAI-ARIA &#8212; <a href="http://www.w3.org/TR/wai-aria/states_and_properties">Supported States and Properties</a></li>
				</ul>
			</section>
			...
			<section id="sc015-res" class="res">
				...
				<ul>
					...
					<li><a href="http://www.w3.org/TR/wai-aria-practices/#accessiblewidget">WAI-ARIA Authoring Practices &#8212; General Steps for Building an Accessible Widget with WAI-ARIA</a></li>
				</ul>
			</section>
		</section>
